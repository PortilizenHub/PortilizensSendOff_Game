...
class FlxAnimationController implements IFlxDestroyable
{
	...
	public var finishedMSGSent:Bool;
	...
	public function update(elapsed:Float):Void
	{
		...
		if (_curAnim.finished && !finishedMSGSent)
		{
			finishedMSGSent = true;
			trace('FINISHED ANIMATION ' + _curAnim);
		}
	}
